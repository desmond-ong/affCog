...
// 6 Less Extreme Faces + 6 Ambiguous
var faceArray = [
            {"faceID":"9",  "faceValence":-2, "faceArousal":1,  "path":"face_-2_1_1"},
            {"faceID":"13", "faceValence":2,  "faceArousal":1,  "path":"face_2_1_1"},
            {"faceID":"17", "faceValence":-1, "faceArousal":2,  "path":"face_-1_2_1"},
            {"faceID":"19", "faceValence":1,  "faceArousal":2,  "path":"face_1_2_1"},
            {"faceID":"23", "faceValence":-2, "faceArousal":3,  "path":"face_-2_3_1"},
            {"faceID":"27", "faceValence":2,  "faceArousal":3,  "path":"face_2_3_1"},
            {"faceID":"36",  "faceValence":4, "faceArousal":4,  "path":"aface_1"},
            {"faceID":"37", "faceValence":4,  "faceArousal":5,  "path":"aface_2"},
            {"faceID":"38", "faceValence":4, "faceArousal":6,  "path":"aface_3"},
            {"faceID":"39", "faceValence":4,  "faceArousal":7,  "path":"aface_4"},
            {"faceID":"40", "faceValence":4, "faceArousal":8,  "path":"aface_5"},
            {"faceID":"41", "faceValence":4,  "faceArousal":9,  "path":"aface_6"}
            ];
...
*/
  ...
  faceIDArray: new Array(numTrials),
  faceValenceArray: new Array(numTrials),
  faceArousalArray: new Array(numTrials),

  occludeFace: new Array(numTrials),
...
*/
  ...
  if (numComplete > 0) {
    canvas.clear();
        ...
        //faceToShow = faceArray[Math.floor(Math.random()*6)];
        faceToShow = faceArray[Math.floor(Math.random()*12)];
            experiment.faceIDArray[numComplete] = faceToShow.faceID;
            experiment.faceValenceArray[numComplete] = faceToShow.faceValence;
            experiment.faceArousalArray[numComplete] = faceToShow.faceArousal;
        ...
        bobNameText = canvas.text(canvas.width/4*3,260,charName + "'s face \n after seeing the wheel").attr({"font-size": 20});


        whichToOcclude = Math.floor(Math.random()*3); // 0 = neither, 1 = face, 2 = wheel
        experiment.occludeFace[numComplete] = 1*(whichToOcclude==1);
